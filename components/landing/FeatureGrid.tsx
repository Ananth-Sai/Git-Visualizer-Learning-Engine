...
export const FeatureGrid: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      glow: 'group-hover:border-indigo-500/50 group-hover:shadow-[0_0_30px_rgba(99,102,241,0.18)]',
      iconBg: 'bg-indigo-500/10 border-indigo-400/20 group-hover:bg-indigo-500/20 group-hover:border-indigo-400/40',
    },
  ];
        ...
        {features.map((f, idx) => {
          ...
          return (
            <motion.div
              ...
              className={`group relative p-6 rounded-[24px] glass-panel-elevated shadow-lg border border-white/5 space-y-4 flex flex-col justify-between cursor-pointer overflow-hidden ${f.glow}`}
            >
              ...
              <div className="space-y-3 relative z-10">
                <div
                  className={`w-11 h-11 rounded-2xl border flex items-center justify-center transition-all duration-150 transform group-hover:scale-110 group-hover:-rotate-3 ${f.iconBg}`}
                >
